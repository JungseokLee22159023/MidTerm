...
public class Playermovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        bool isWalking = hasHorizontalInput ll hasVerticalInput;
        ...
        Vector3 desiredFoward = Vector3.RotateTowards(transform.forward, movement, tumSpeed + TimefixedDeltaTime, 0f);
